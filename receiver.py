...
import message
import definitions
from message.streaming import StreamingRequestMessage
from message.null import NullMessage
...
# settings
    ...
    def init(self):
        ...
        eventMessage = message.EventStreamRequestMessage(timestamp, flags)
